...
const useGlobalLoading = ({ authMode, connectedInfo, connectedWallet, projectSettings, primaryWallet, user, walletBook, }) => {
    var _a;
    ...
    const primaryWalletIsLoading = user &&
        ...
        !primaryWallet;
    const connectOnlyUserIsLoading = authMode === 'connect-only' && connectedInfo && !connectedWallet;
    React.useEffect(() => {
        var _a;

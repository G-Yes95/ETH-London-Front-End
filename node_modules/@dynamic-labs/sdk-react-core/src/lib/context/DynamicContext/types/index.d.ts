...
export interface IDynamicContext {
    ...
    bridgeChainToConnect: Chain | undefined;
    setBridgeChainToConnect: Dispatch<SetStateAction<Chain | undefined>>;
    clearStatesOnBackClick: () => void;
    computeConnectedStateForWallets: () => Promise<void>;
    connectWallet: (walletConnector: WalletConnector, fetchPublicAddressOpts?: FetchPublicAddressOpts, shouldCallCallback?: boolean) => Promise<string | undefined>;
    ...
    walletsByChain: ChainsToConnect[] | undefined;
    walletsToConnectByChain: ChainsToConnect[] | undefined;
    setWalletsToConnectByChain: Dispatch<SetStateAction<ChainsToConnect[] | undefined>>;
    desktopUri: string;
    ...
    setSelectedWalletConnector: (connector: WalletConnector | null) => void;

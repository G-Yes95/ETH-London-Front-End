...
import { useWallets } from '../../utils/hooks/useWallets/useWallets.js';
import { useWalletConnectors } from '../../utils/hooks/useWalletConnectors/useWalletConnectors.js';
import { sendDynamicProps, revokeSession } from '../../data/api.js';
...
import { useFetchNetworkConfigurations } from '../../utils/hooks/useFetchNetworkConfigurations/useFetchNetworkConfigurations.js';
...
const DynamicContextProvider = ({ children, theme, settings, locale, }) => {
    ...
    const isBridgeFlow = Boolean(walletsByChain);
    const [bridgeChainToConnect, setBridgeChainToConnect] = useState(undefined);
    ...
    const [walletsToConnectByChain, setWalletsToConnectByChain] = useState(walletsByChain);
    ...
    const { configurations: serverNetworkConfigurations, handleRemoveLsNetworks, } = useFetchNetworkConfigurations({
        authToken: getAuthToken(),
        environmentId,
        evmNetworks,
    });
    ...
    const { connectWallet, removeConnectedWalletsInfo, connectedWalletsInfo, connectedWallet, getConnectedWalletById, connectedWallets, disconnectWallet, refreshConnectedWallet, } = useConnectWallet({
        authMode,
    ...
    useEffect(() => {
        const missingChains = getMissingChains(walletsByChain, connectedWalletsInfo);
        setWalletsToConnectByChain(missingChains);
    }, [walletsByChain]);
    ...
    const { computeConnectedStateForWallets, didConnectedStateLoad, walletConnectors, primaryWallet, showQrcodeModal, secondaryWallets, setPrimaryWallet, setShowQrcodeModal, wallets: linkedOrConnectedWallets, } = useWalletConnectors({
        authMode,
    ...
    useSetWalletConnectorVerifiedCredentials(authToken, wallets);
    const { getNameService, removeConnectedNameService } = useNameService({
        authToken,
        currentWallet: primaryWallet !== null && primaryWallet !== void 0 ? primaryWallet : connectedWallet,
    });
    ...
    const handleLogOut = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        setWalletsToConnectByChain(walletsByChain);
        ...
        yield ((_j = connectedWallet === null || connectedWallet === void 0 ? void 0 : connectedWallet.connector) === null || _j === void 0 ? void 0 : _j.endSession());
        ...
        if (connectedWallet) {
            (_k = eventsCallbacks === null || eventsCallbacks === void 0 ? void 0 : eventsCallbacks.onDisconnect) === null || _k === void 0 ? void 0 : _k.call(eventsCallbacks, {
                walletConnector: connectedWallet === null || connectedWallet === void 0 ? void 0 : connectedWallet.connector,
            });
        }
        (_l = eventsCallbacks === null || eventsCallbacks === void 0 ? void 0 : eventsCallbacks.onLogout) === null || _l === void 0 ? void 0 : _l.call(eventsCallbacks, user);
    ...
    return (jsx(I18nextProvider, { i18n: i18nSDKInstance, children: jsx(DynamicContext.Provider, { value: value, children: jsx(WalletBookContextProvider, { walletBook: walletBook, children: jsx(ThemeContextProvider, { customerTheme: parseTheme(theme, ((_h = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.design) === null || _h === void 0 ? void 0 : _h.modal) || undefined), designSettings: projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.design, children: jsx(LoadingContextProvider, { children: jsx(ErrorContextProvider, { children: jsxs(ViewContextProvider, { initialView: getInitialView({
                                    ...
                                    isFullyConnected,
                                    isMultiWalletEnabled: multiWallet,
                                }), internalEvents: internalEventsRef, children: [enableForcedNetworkValidation && jsx(UseNetworkValidation, {}), jsx(AccountExistsContextProvider, { children: jsx(WalletContextProvider, { canSync: didConnectedStateLoad, children: jsx(QrCodeContextProvider, { children: jsx(EmailVerificationContextProvider, { children: jsx(DynamicWidgetContextProvider, { children: jsx(DynamicBridgeWidgetContextProvider, { children: jsx(CaptchaContextProvider, { children: jsx(FundingContextProvider, { children: jsx(AccessDeniedContextProvider, { children: jsx(SendBalanceContextProvider, { children: jsx(WalletGroupContextProvider, { children: jsxs(UserFieldEditorContextProvider, { children: [jsx(DynamicAuthFlow, {}), jsx(Toolkit, {}), jsx(FundingWidget, {}), jsx(SyncPasskeyFlow, {}), confirmationModal, children] }) }) }) }) }) }) }) }) }) }) }) })] }) }) }) }) }) }) }));
};

export { DynamicContext, DynamicContextProvider, PUBLIC_PROJECT_LIVE_ENVIRONMENT_ID };

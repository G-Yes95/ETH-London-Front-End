...
const handleDisconnectWallet = ({ wallet, connectedWalletsInfo, walletsByChain, setWalletsToConnectByChain, eventsCallbacks, }) => {
    var _a;
    const missingChains = getMissingChains.getMissingChains(walletsByChain, connectedWalletsInfo);

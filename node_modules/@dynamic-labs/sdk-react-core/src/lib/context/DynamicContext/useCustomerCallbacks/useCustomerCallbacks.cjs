...
const useCustomerCallbacks = ({ callbacks: { onAuthSuccess, onLinkSuccess, onUserProfileUpdate, onConnect, onBeforeConnectSuccessConfirmation, onEmailVerificationFailure, onEmailVerificationSuccess, onEmbeddedWalletCreated, }, handleLogOut, primaryWallet, selectedWalletConnector, user, isAuthenticated, authMode, setIsVerificationInProgress, }) => {
    ...
    const handleConnectOnlyAndCallbackIsConnectSuccess = React.useCallback(() => {
        const [{ callback: peek }] = callbackQueue;
            ...
            case 'linkSuccess': {
                try {
                    onLinkSuccess === null || onLinkSuccess === void 0 ? void 0 : onLinkSuccess({
                        ...
                        primaryWallet,
                        user,
                        walletConnector: (_e = next.params) === null || _e === void 0 ? void 0 : _e.walletConnector,
                    });
                }
                catch (e) {

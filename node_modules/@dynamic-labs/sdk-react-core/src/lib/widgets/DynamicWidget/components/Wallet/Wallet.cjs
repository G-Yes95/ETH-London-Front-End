...
const Wallet = ({ wallet, ens }) => {
    ...
    const { computeConnectedStateForWallets, setPrimaryWallet, setSelectedWalletConnector, setShowWidgetStatePopup, setSelectedWalletWithAction, authToken, primaryWallet, user, projectSettings, authMode, } = useInternalDynamicContext.useInternalDynamicContext();
    ...
    const onSelectWalletClick = () => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        ...
        setSelectedWalletConnector(connector);
    });

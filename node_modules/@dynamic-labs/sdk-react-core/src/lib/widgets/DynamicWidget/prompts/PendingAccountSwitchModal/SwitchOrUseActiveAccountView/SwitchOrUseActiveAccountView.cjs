...
const SwitchOrUseActiveAccountView = ({ connectedWallet, selectedWalletToSwitchTo, }) => {
    const { setSelectedWalletWithAction, setSelectedWalletConnector, computeConnectedStateForWallets, setPrimaryWallet, } = useInternalDynamicContext.useInternalDynamicContext();
    const onUseActiveWalletClick = React.useCallback(() => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        ...
        setSelectedWalletConnector(connectedWallet === null || connectedWallet === void 0 ? void 0 : connectedWallet.connector);
    }), [
        connectedWallet,

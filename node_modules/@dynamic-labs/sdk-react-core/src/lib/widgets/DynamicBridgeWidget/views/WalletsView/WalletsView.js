...
const WalletsView = () => {
    const { disconnectWallet, walletsByChain, connectedWallets } = useInternalDynamicContext();
    return (jsxs(Fragment, { children: [jsx("div", { className: 'dynamic-bridge-widget-wallets-view', "data-testid": 'dynamic-bridge-wget-wallets-view', children: walletsByChain === null || walletsByChain === void 0 ? void 0 : walletsByChain.map(({ chain }) => {

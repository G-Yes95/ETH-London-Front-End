...
const DynamicBridgeWalletCard = ({ className, networkIcon, networkName, children }) => (jsxs("div", { className: classNames('dynamic-bridge-wallet-card', className), children: [jsxs("div", { className: 'dynamic-bridge-wallet-card__network', children: [networkIcon &&
                    React__default.cloneElement(networkIcon, {
                        className: 'dynamic-bridge-wallet-card__network-icon',
                    }), networkName && (jsxs(Typography, { className: 'dynamic-bridge-wallet-card__network-name', variant: 'body_small', color: 'primary', weight: 'medium', as: 'span', children: [networkName, " wallet"] }))] }), children] }));

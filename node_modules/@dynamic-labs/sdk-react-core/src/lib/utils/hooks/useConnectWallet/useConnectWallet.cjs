...
const useConnectWallet = ({ authMode, clearPrimaryWalletId, enableVisitTrackingOnConnectOnly, environmentId, primaryWalletId, setPrimaryWalletId, wallets, onDisconnect, onBeforeConnectSuccessConfirmation, setShowAuthFlow, isBridgeFlow, }) => {
    ...
    const updateConnectedWalletsList = React.useCallback(() => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        const walletConnectors = wallets.map((wallet) => wallet.walletConnector);
    ...
    }), [connectedWalletsInfo, disconnectWallet, wallets]);
    ...
    const connectedWallet = connectedWallets[0] || null;
    ...
    const connectWallet = (walletConnector, fetchPublicAddressOpts, shouldCallCallback = true) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        const publicWalletAddress = yield walletConnector.fetchPublicAddress(fetchPublicAddressOpts);
        if (!publicWalletAddress) {
            const error = new Error();
            error.code = 'missing-public-address';
            throw error;
        }

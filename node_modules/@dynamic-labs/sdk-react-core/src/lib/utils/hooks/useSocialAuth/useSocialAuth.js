...
import { SocialAccountAlreadyExistsError, NoAccessError } from '@dynamic-labs/utils';
...
const useSocialAuth = ({ sessionTimeout, authMode, onSettled, onError, }) => {
    ...
    const signInAccount = (provider, code, verifier, state) => __awaiter(void 0, void 0, void 0, function* () {
        var _b;
        try {
    ...
    const connectSocialAccount = (provider, validator) => __awaiter(void 0, void 0, void 0, function* () {
        var _c, _d;
        ...
        const handleAuthWindowMessage = (event) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (authMode === 'signin') {
                yield signInAccount(provider, code, verifier, state);
            }
            else {

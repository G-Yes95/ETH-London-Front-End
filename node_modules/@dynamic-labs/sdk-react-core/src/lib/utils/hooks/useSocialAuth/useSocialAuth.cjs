...
const useSocialAuth = ({ sessionTimeout, authMode, onSettled, onError, }) => {
    ...
    const signInAccount = (provider, code, verifier, state) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        var _b;
        try {
    ...
    const connectSocialAccount = (provider, validator) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        var _c, _d;

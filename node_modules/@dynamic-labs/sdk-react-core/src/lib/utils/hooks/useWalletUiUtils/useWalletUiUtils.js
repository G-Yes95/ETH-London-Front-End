...
import '../useWallets/utils/verifyMagicIsSetup/verifyMagicIsSetup.js';
...
const useWalletUiUtils = ({ appLogoUrl, appName, getAppOrigin, }) => {
    ...
    const sendTransaction = useCallback(({ transaction, handler, provider, connector }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return openSendTransaction((resolve, reject) => (jsx(TransactionConfirmationModal, { walletConnector: connector, title: t('dyn_send_transaction.confirmation.title'), transaction: transaction, handler: handler, onTransactionResponseSuccess: resolve, onReject: reject, provider: provider })));

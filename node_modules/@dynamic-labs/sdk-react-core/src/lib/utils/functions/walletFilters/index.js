...
const FilterWalletsByChainName = (chainName) => (wallets) => wallets.filter((wallet) => wallet.walletConnector.supportedChains.includes(chainName));
/**
...
export { FilterAndSortWallets, FilterWallets, FilterWalletsByChainName, RemoveWallets, SortWallets, UniswapFilter };

...
const groupWalletOptions = (walletBook$1, walletOptionList) => {
    ...
    walletOptionList.forEach((currentWalletOption) => {
        ...
        const isThereWalletOptionWithSameGroup = walletOptionList.some((walletOption) => {
            var _a;
            return currentWalletOption.group === walletOption.group &&
                (((_a = walletOption.injectedConfig) === null || _a === void 0 ? void 0 : _a.length) ||
                    currentWalletOption.key !== walletOption.key);
        });

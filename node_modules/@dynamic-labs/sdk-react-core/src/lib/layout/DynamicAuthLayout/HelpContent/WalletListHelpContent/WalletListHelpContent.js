...
const WalletListHelpContent = ({ chains, newToWeb3WalletChainMap, }) => {
    var _a, _b;
    const { wallets } = useInternalDynamicContext();
    ...
    const newToWeb3Wallet = wallets.find((wallet) => { var _a; return normalizeWalletName((_a = wallet.key) !== null && _a !== void 0 ? _a : wallet.name) === walletName; });

...
const SendBalanceView = ({ initialRecipientAddress = '', initialValue, onClickBack, onClickClose, onError, onSuccess, onDone, displayPoweredByDynamicFooter = false, }) => {
    ...
    const ChainIconComponent = getChainIcon.getChainIcon(primaryWallet.chain);
    const chainInfo = walletConnectorCore.getChainInfo(primaryWallet.chain);
    const chainIcon = (jsxRuntime.jsx(Icon.Icon, { size: 'small', children: jsxRuntime.jsx(ChainIconComponent, {}) }));
    ...
    const buildTransactionStage = () => {
        ...
        return (jsxRuntime.jsx(TransactionStage.TransactionStage, { walletConnector: walletConnector, provider: provider, transaction: transaction, title: t('dyn_send_transaction.confirmation.title'), onClickBack: () => setStage('form'), onError: onError, displayPoweredByDynamicFooter: displayPoweredByDynamicFooter, mutation: ({ to, value, gasPrice, nonce }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const buildSuccessState = () => {
        ...
        if (value === null)
            return null;
        return (jsxRuntime.jsx(TransactionStatusLayout.TransactionStatusLayout, { amount: formatBigNumber.formatBigNumber(value), destinationAddress: recipientAddress, networkCurrency: currencySymbol, networkName: (_a = chainInfo === null || chainInfo === void 0 ? void 0 : chainInfo.blockchainName) !== null && _a !== void 0 ? _a : '', NetworkIcon: chainIcon, onClickClose: onClickClose, onDone: () => onDone === null || onDone === void 0 ? void 0 : onDone(), displayPoweredByDynamicFooter: displayPoweredByDynamicFooter }));
    };

...
const WalletUsedView = () => {
    ...
    const handleWalletTransfer = () => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const publicWalletAddress = yield connectWallet(walletConnector);
            ...
            setUser(userProfile);
            setCallback('linkSuccess', { walletConnector });
        }
        catch (error) {

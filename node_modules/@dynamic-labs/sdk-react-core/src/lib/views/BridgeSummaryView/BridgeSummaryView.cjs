...
const BridgeSummaryView = () => {
    const { primaryWallet, setShowAuthFlow, appName, walletsByChain = [], } = useInternalDynamicContext.useInternalDynamicContext();
    ...
    return (jsxRuntime.jsxs(ConnectedWalletsListLayout.ConnectedWalletsListLayout, { onClickClose: onClickClose, onClickAction: onClickClose, title: t('dyn_bridge.summary_view.title', { appName }), body: body, children: [primaryWallet && createPrimaryWalletCard(primaryWallet), jsxRuntime.jsx(SecondaryWallets.MemoSecondaryWallets, { hideUnlinkAction: true })] }));
};

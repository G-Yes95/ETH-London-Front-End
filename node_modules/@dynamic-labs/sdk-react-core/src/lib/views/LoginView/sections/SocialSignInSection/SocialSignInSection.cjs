...
const SocialSignInSection = ({ sectionData, collapsedLayout, }) => {
    ...
    const isDynamicEnabled = isProviderEnabled.isProviderEnabled(providers, sdkApi.ProviderEnum.Dynamic) ||
    ...
    if (isDynamicEnabled &&
        ((_c = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.sdk.socialSignIn) === null || _c === void 0 ? void 0 : _c.signInProvider) ===

...
const NetworkNotSupportedSwitchManual = () => {
    var _a, _b;
    const { user, selectedWalletConnector: walletConnector, connectedWallets, isFullyConnected, setShowAuthFlow, walletsToConnectByChain, } = useInternalDynamicContext();

...
const NetworkNotSupportedSwitchManual = () => {
    var _a, _b;
    const { user, selectedWalletConnector: walletConnector, connectedWallets, isFullyConnected, setShowAuthFlow, walletsToConnectByChain, } = useInternalDynamicContext.useInternalDynamicContext();
    ...
    const finishConnectAndSign = useConnectAndSign.useConnectAndSign({
        ...
        shouldUpdateWallets: !isFullyConnected ||
            (isFullyConnected && Boolean(walletsToConnectByChain === null || walletsToConnectByChain === void 0 ? void 0 : walletsToConnectByChain.length)),
    });

...
const createEmailVerification = ({ email, environmentId, }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
...
const signInWithEmailVerification = ({ verificationToken, verificationUUID, environmentId, }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
...
const fetchNetworkSettings = (environmentId) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
...
const signInOAuth = (environmentId, providerType, { code, codeVerifier, state }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    const oauthRequest = {
        code,
        codeVerifier,
        state,
...
const sendDynamicProps = (environmentId, settingsToSend) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (dynamicContextProps) {
            yield sendDynamicContextSettings(environmentId, { dynamicContextProps }, helpers.isDynamicContextSessionSettingExpired, helpers.setDynamicContextSessionSettings);
        }
            ...
            embeddedWallets: [
                {
                    ...
                    embeddedWalletProvider: sdkApi$1.EmbeddedWalletProviderEnum.Turnkey,

...
import { SDKApi, Configuration, UnprocessableEntityErrorCode, ChainEnum, EmbeddedWalletProviderEnum, VerifyRequestFromJSON, WalletProviderEnum, AuthModeEnum } from '@dynamic-labs/sdk-api';
...
const createEmailVerification = ({ email, environmentId, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const signInWithEmailVerification = ({ verificationToken, verificationUUID, environmentId, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const fetchNetworkSettings = (environmentId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const res = yield sdkApi().getNetworksConfigurationByEnvId({
            environmentId,
        });
        return res;
    }
...
const signInOAuth = (environmentId, providerType, { code, codeVerifier, state }) => __awaiter(void 0, void 0, void 0, function* () {
    const oauthRequest = {
        code,
        codeVerifier,
        state,
...
const sendDynamicProps = (environmentId, settingsToSend) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { dynamicContextProps, dynamicWagmiSettings } = settingsToSend;
        if (dynamicContextProps) {
            yield sendDynamicContextSettings(environmentId, { dynamicContextProps }, isDynamicContextSessionSettingExpired, setDynamicContextSessionSettings);
        }
    ...
    return sdkApi(userJwt).createEmbeddedWallets({
        createEmbeddedWalletsRequest: {
            embeddedWallets: [
                {
                    chain: ChainEnum.Evm,
                    embeddedWalletProvider: EmbeddedWalletProviderEnum.Turnkey,

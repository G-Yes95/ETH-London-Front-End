 ...
 */
const createTurnkeyTransport = ({ account, transport, getClient, }) => (props) => viem.custom({
    request: (args) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        ...
        if (method === 'eth_sendTransaction') {
            ...
            return client.sendTransaction(unFormatTransaction.unFormatTransaction(transaction));
        }
...
exports.createTurnkeyTransport = createTurnkeyTransport;

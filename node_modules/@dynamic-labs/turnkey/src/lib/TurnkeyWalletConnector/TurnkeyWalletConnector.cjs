...
var createTurnkeyWalletClient = require('../utils/createTurnkeyWalletClient/createTurnkeyWalletClient.cjs');
...
class TurnkeyWalletConnector extends walletConnectorCore.WalletConnectorBase {
    ...
    getWalletClient() {
        ...
        return createTurnkeyWalletClient.createTurnkeyWalletClient({
            account,
            connector: this,
            evmNetwork,
            rpcUrl,
